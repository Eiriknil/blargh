...
public enum Skills {
	...
	LORE_POLITICS(INT), LORE_ANATOMY(INT), 
	...
	TRACK(I), TRADE_APOTHECARY(DEX), TRADE_ENGINEER(DEX), TRADE_POISONER(DEX), TRADE_BREWER(DEX), TRADE_HERBALIST(DEX), TRADE_VINTNER(DEX), TRADE_BARBER(DEX);
	...
	public static Set<Skills> advancedSkills(){
		return new HashSet<>(Arrays.asList(ANIMAL_CARE, ANIMAL_TRAINING, CHANNELING, EVALUATE, HEAL, 
				...
				LORE_ANATOMY, PERFORM, PICK_LOCK, 
				PLAY, 
				PRAY, 
