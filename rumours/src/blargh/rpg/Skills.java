...
public enum Skills {
	...
	public static Set<Skills> basicSkills(){
		return new HashSet<>(Arrays.asList(ART_WRITING, ART_CALLIGRAPHY, ATHLETICS, BRIBERY, CHARM, CHARM_ANIMAL, CLIMB, COOL,
				CONSUME_ALCOHOL, DODGE, DRIVE, ENDURANCE, ENTERTAIN_SPEECHES, ENTERTAIN_STORYTELLING, ENTERTAIN_LECTURE, ENTERTAIN_RHETORIC, ENTERTAIN_ACTING, ENTERTAIN_ANY, GAMBLE,
