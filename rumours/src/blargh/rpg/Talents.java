...
public enum Talents {
	ACCURATE_SHOT, ACUTE_SENSE_TASTE, ACUTE_SENSE_TOUCH, ACUTE_SENSE_ANY, AETHYRIC_ATTUNEMENT, ALLEY_CAT, AMBIDEXTROUS, ANIMAL_AFFINITY, ARCANE_MAGIC_ANY, ARGUMENTATIVE, ARTISTIC, ATTRACTIVE,
	...
	COOLHEADED, CRACK_THE_WHIP, CRAFTSMAN_APOTHECARY, CRAFTSMAN_ENGINEER, CRAFTSMAN_ANY, CRIMINAL, DEADEYE_SHOT, DEALMAKER, DETECT_ARTEFACT, DICEMAN, DIRTY_FIGHTING, 
	DISARM, DISTRACT, DOOMED, 
	DRILLED, DUAL_WIELDER, EMBEZZLE, ENCLOSED_FIGHTER, ETIQUETTE_GUILDER, ETIQUETTE_NOBLES, ETIQUETTE_SERVANTS, ETIQUETTE_CRIMINALS, ETIQUETTE_CULTISTS, ETIQUETTE_SOLDIERS, ETIQUETTE_SCHOLAR, ETIQUETTE_ANY, FAST_HANDS, FAST_SHOT, 
	FEARLESS_OUTLAWS, FEARLESS_WATCHMEN, FEARLESS_CRIMINALS, FEARLESS_RATS, FEARLESS_SKAVEN, FEINT, FIELD_DRESSING, FISHERMAN, 
	...
	MASTER_TRADESMAN_POISONER, MASTER_TRADESMAN_ENGINEERING, MASTER_TRADESMAN_ANY, MENACING, MIMIC, NIGHT_VISION, NIMBLE_FINGERED(DEX, 5), NOBLE_BLOOD, NOSE_FOR_TROUBLE, NUMISMATICS, 
	OLD_SALT, ORIENTATION, PANHANDLE, PERFECT_PITCH, 
	PETTY_MAGIC, 
	PHARMACIST, PILOT, PUBLIC_SPEAKER, PURE_SOUL, RAPID_RELOAD, REACTION_STRIKE, READ_WRITE, RELENTLESS, RESISTANCE_POISON, RESISTANCE_DISEASE, RESISTANCE_ANY, RESOLUTE, REVERSAL, 
	RIPOSTE, 
	RIVER_GUIDE, ROBUST, ROUGHRIDER, ROVER, SAVANT_APOTHECARY, SAVANT_THEOLOGY, SAVANT_ENGINEERING, SAVANT_LAW, SAVANT_ANY, SAVVY(INT, 5), SCALE_SHEER_SURFACE, SCHEMER, 
	...
	VERY_STRONG(S, 5), WARLEADER, WAR_WIZARD, WARRIOR_BORN, WATERMAN, WEALTHY, WELLPREPARED, WITCH;
