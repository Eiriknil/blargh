...
public enum Talents {
	...
	DRILLED, DUAL_WIELDER, EMBEZZLE, ENCLOSED_FIGHTER, ETIQUETTE, FAST_HANDS, FAST_SHOT, FEARLESS, FEINT, FIELD_DRESSING, FISHERMAN, 
	FLAGELLANT, FLEE, FLEET_FOOTED, FRENZY, FRIGHTENING, FURIOUS_ASSAULT, GREGARIOUS, GUNNER, HARDY, HATRED, HOLY_HATRED, HOLY_VISIONS, HUNTERS_EYE, 
	...
	MENACING, MIMIC, NIGHT_VISION, NIMBLE_FINGERED(DEX, 5), NOBLE_BLOOD, NOSE_FOR_TROUBLE, NUMISMATICS, OLD_SALT, ORIENTATION, PANHANDLE, PERFECT_PITCH, PETTY_MAGIC, 
	PHARMACIST, PILOT, PUBLIC_SPEAKER, PURE_SOUL, RAPID_RELOAD, REACTION_STRIKE, READ_WRITE, RELENTLESS, RESISTANCE_THREAT, RESOLUTE, REVERSAL, RIPOSTE, 
	RIVER_GUIDE, ROBUST, ROUGHRIDER, ROVER, SAVANT_LORE, SAVVY(INT, 5), SCALE_SHEER_SURFACE, SCHEMER, SEA_LEGS, SEASONED_TRAVELLER, SECOND_SIGHT, SECRET_IDENTITY, 
